...
function deployAll(ISuperfluid host, ISuperToken subscriptionSuperToken, address protocolFeeDest, address initialOwner)
    returns (address fanTokenProxy, address channelLogicAddress, address channelFactoryAddress)
{
    ...
    Channel channelLogic = new Channel(host, protocolFeeDest, subscriptionSuperToken, fanToken);
